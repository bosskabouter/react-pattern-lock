...
var PatternLock = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement("div", { className: (0, classnames_1.default)(["react-pattern-lock__pattern-wrapper", { error: error, success: success, disabled: disabled }, className]), style: __assign(__assign({}, style), { width: width, height: height }), onMouseDown: onHold, onTouchStart: onTouch, ref: wrapperRef },
            ...
            !invisible && points.length &&
                React.createElement(Connectors_1.default, { initialMousePosition: initialMousePosition, wrapperPosition: position, path: path, points: points, pointActiveSize: pointActiveSize, connectorRoundedCorners: connectorRoundedCorners, connectorThickness: connectorThickness }))));
};
